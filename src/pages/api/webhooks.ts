      ...
      try {
        switch(type) {
          ...
          case 'checkout.session.completed':
            const checkoutSessiont = event.data.object as Stripe.Checkout.Session
            await saveSubscription(checkoutSessiont.subscription.toString(), checkoutSessiont.customer.toString(), true)
            break
          default:
